...
<html lang="en">
    <head>
        ...
        <title>FEST'IN MOTION - Home</title>
    ...
    <body>
        ...
        <section id="corps_page">
            <section id="entete" class="item_page">
                <h2 id="titre_entete">Welcome to the Fest'In Motion festival</h2>
                <p id="description_entete">For this second edition of Fest'In Motion, we offer various and varied outdoor activities.<br/>
                Animation, meetings with producers, film screenings, ... You will find what you are looking for.</p>
            </section>
            ...
            <section id="promo_video" class="item_page">
                ...
                <div id="texte_video">
                    <h2 id="titre_video">You don't know us ?</h2>
                    <p id="description_video">No problem! Here we give you a little overview of what you can discover during the festival, you will necessarily find the right information !</p>
                </div>
            </section>
            
            <section id="preview_galeries" class="item_page">
                <h2 id="titre_preview_galeries">Our gallery</h2>
            ...
            <section id="reservation" class="item_page">
                <h2 id="titre_reservation">Reserve your seats</h2>
                <div id="contenu_reservation">
                    <div id='butt_reservation'>
                    <a href="inscription.php" id="lien_reservation">Reservation</a>
                    </div>
                    <span id="description_reservation">Take your seats to enjoy our show.</span>
                    
                    <div id="tarifs">
                        <div id="prix_adulte">
                        <span>15</span>€00 / adult
                        </div>
                        <div id="prix_enfant">
                        <span>10</span>€00 / child<sup>*</sup>
                        </div>
                        <div>
                        <span id="explication_asterisque"><sup>*</sup>Corresponds to children under 10 years old</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="partenaires" class="item_page">
                <h2 id="titre_partenaires">Our volunteers and partnerships</h2>
                <p id="description_partenaires">They trusted us and they helped us with this incredible project.</p>
